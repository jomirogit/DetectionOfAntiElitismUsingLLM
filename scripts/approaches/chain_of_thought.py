...
def generate_chain_of_thought_statements(definition):
    # Step 1: Generate contexts/settings
    prompt1 = "Generiere ein Thema, das Anti-Elitismus aufgreift."
    response1 = generator(prompt_format.format(prompt=prompt1), do_sample=True, top_p=0.95, max_length=8192)
    ...
    response4 = generator(prompt_format.format(prompt=prompt4), do_sample=True, top_p=0.95, max_length=8192)
